...
$result_of_offer = "SELECT * FROM `product` WHERE `offer` is true";
$on_offer = mysql_query($result_of_offer, $con);
    ...
    <div class="header_bottom_right">
        <div class="slider">
            <div id="slider">
                <div id="mover">
                    <?php
                    while($offers = mysql_fetch_array($on_offer))
                    {?>
                        <div id="slide-1" class="slide">
                        <div class="slider-img">
                            <a target="_blank"><img
                                        style="height: 500px; width:300px"
                                        src="assets/<?php echo $offers['image'] ?>" alt="learn more"/></a>
                        </div>
                        <div class="slider-text">
                            <h1>Season<br><span>SALE</span></h1>
                            <h2>UPTO <?php echo $offers['discount'] . "%" ?> OFF</h2>
                    <div class="features_list">
                        <h4><?php echo $offers['description'] ?></h4>
                    </div>
                    <a href="index.php?page=preview&id=<?php echo $offers['id'] ?>" class="button">Shop Now</a>
                </div>
                <div class="clear"></div>
            </div>
                    <?php
...
<!--                            </div>-->
<!--                            <a href="index.php?page=preview&id=1" class="button">Shop Now</a>-->
<!--                        </div>-->
<!--                        <div class="clear"></div>-->
<!--                    </div>-->
                </div>
        ...
        <div class="section group">
            <?php while ($rr = mysql_fetch_array($res)) { ?>
                <div class="grid_1_of_4 images_1_of_4">
                    <a href="Admin/images/<?php echo $rr['image'] ?>"><img id="myImg" height=210px width:150px;
                                                                           src="Admin/images/<?php echo $rr['image'] ?>"
                                                                           alt=""/></a>
