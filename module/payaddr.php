...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        $stkPushSimulation=$mpesa->STKPushSimulation(247247, "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919", "CustomerPayBillOnline", 10, 254711154321, 174379, 254711154321,"https://api.kerberos.co.ke/mpesa/response.php", "Uptown-Fresh", "stk online payment", "testing");
    ...
    <div class="a1">
        ...
        <label>Select card<label>
                ...
                <input type="text" name="number" class="form-control" required="required"
                       data-encrypted-attribute="card_number">
                <br><br>
                <label>CVV</label><br>
                ...
                <br>
                <input type="submit" name="submit" value="Finish Payment" id="btnPay"
                       class="btn_blue fullsize btn-primary mondidocheckout"><br><br>
